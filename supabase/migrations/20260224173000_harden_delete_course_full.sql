...
BEGIN
  ...
  IF to_regclass('public.comissoes_professores') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'comissoes_professores' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.transacoes_pagamento') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'transacoes_pagamento' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.certificados') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'certificados' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.prova_resultado') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'prova_resultado' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.prova_questoes') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'prova_questoes' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.questionarios') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'questionarios' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.respostas_questionario') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'respostas_questionario' AND column_name = 'questionario_id'
    ) INTO has_column;
    IF has_column THEN
  ...
  IF to_regclass('public.modulos') IS NOT NULL THEN
    SELECT EXISTS (
      SELECT 1 FROM information_schema.columns
      WHERE table_schema = 'public' AND table_name = 'modulos' AND column_name = 'curso_id'
    ) INTO has_column;
    IF has_column THEN
