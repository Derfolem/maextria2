    ...
    <div className={`min-h-screen flex flex-col${isMemberArea ? ' member-theme' : ''}`}>
              ...
              <>
                ...
                {user?.role === 'admin' && (
                  <>
                    ...
                    <Link to="/admin/trilhas" className="nav-link" onClick={() => setMobileOpen(false)}>
                      Trilhas
                    </Link>
      ...
      <footer className="bg-[hsl(var(--background))] text-[hsl(var(--foreground))] py-12 border-t border-[hsl(var(--border))]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-[hsl(var(--border))] pb-6">
            <div className="flex items-center gap-3">
              <img src="/maextria-logo.png" alt="MAEXTRIA" className="h-9 w-9 x-glow" />
              <span className="text-lg font-semibold tracking-wide">MAEXTRIA</span>
            </div>
            <div className="flex flex-wrap gap-6 text-sm text-[hsl(var(--footer-foreground))]">
